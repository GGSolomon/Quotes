...
export class QuotesComponent implements OnInit {
  ...
  quotes = [
    ...
    new Quote(' Chaos isn’t a pit. Chaos is a ladder. Many who try to climb it fail and never get to try again. The fall breaks them', 'Petyr Baelish', 'GGSolomon', new Date(2020, 4, 28, 7, 43), 0, 0),
    new Quote(' They were the shields that guarded the realms of men. And we shall never see their like again.', 'Jon Snow', 'GGSolomon', new Date(2020, 4, 28, 7, 45), 0, 0),
    new Quote(' Any man who must say I am the king is no true king', 'Tywin Lannister', 'GGSolomon', new Date(2020, 10, 9, 13, 1), 0, 0),
    new Quote(' When the snows fall and the white winds blow, the lone wolf dies but the pack survives', 'Ned Stark', 'GGSolomon', new Date(2020, 4, 28, 7, 49), 0, 0),
